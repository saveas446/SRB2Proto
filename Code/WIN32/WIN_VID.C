...
void VID_Init (void)
{
    ...
    COM_AddCommand ("vid_nummodes", NULL, CAT_VIDEO, VID_Command_NumModes_f);
    COM_AddCommand ("vid_modeinfo", NULL, CAT_VIDEO, VID_Command_ModeInfo_f);
    COM_AddCommand ("vid_modelist", NULL, CAT_VIDEO, VID_Command_ModeList_f);
    COM_AddCommand ("vid_mode", NULL, CAT_VIDEO, VID_Command_Mode_f);
