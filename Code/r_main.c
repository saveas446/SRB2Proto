...
consvar_t cv_tiltview = {"tiltview","0", NULL, CAT_VIDEO, 0,CV_OnOff};

// added 16-6-98:splitscreen

void SplitScreen_OnChange(void);

consvar_t cv_splitscreen = {"splitscreen","0", NULL, CAT_MISC, CV_CALL | CV_NOTINNET,CV_OnOff,SplitScreen_OnChange};
